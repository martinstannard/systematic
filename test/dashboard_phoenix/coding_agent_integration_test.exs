defmodule DashboardPhoenix.CodingAgentIntegrationTest do
  ...
  describe "OpenClawClient interface" do
    test "work_on_ticket/3 function exists and accepts expected parameters" do
      ...
      expect(OpenClawClientMock, :work_on_ticket, fn "COR-123",
                                                     "Test details",
      ...
      result =
        client.work_on_ticket("COR-123", "Test details", model: "anthropic/claude-opus-4-5")
    ...
    test "work_on_ticket/3 accepts model option" do
      ...
      for model <- models do
        ...
        expect(OpenClawClientMock, :work_on_ticket, fn "COR-456",
                                                       "Test with " <> ^model,
                                                       [model: ^model] ->
    ...
    test "work_on_ticket/3 handles nil details" do
      ...
      expect(OpenClawClientMock, :work_on_ticket, fn "COR-789",
                                                     nil,
  ...
  describe "coding agent selection logic verification" do
    ...
    test "claude preference should call OpenClawClient.work_on_ticket" do
      ...
      expect(OpenClawClientMock, :work_on_ticket, fn "LOGIC-TEST-2",
                                                     "Test Claude logic",
                                                     [model: "anthropic/claude-sonnet-4-20250514"] ->
  ...
  describe "error scenarios" do
    test "OpenCodeClient handles server not running gracefully" do
      ...
      expect(OpenCodeClientMock, :send_task, fn "Test when server down",
                                                [model: "gemini-3-pro"] ->
    ...
    test "OpenClawClient handles openclaw command not available" do
      ...
      expect(OpenClawClientMock, :work_on_ticket, fn "ERROR-TEST",
                                                     "Test error handling",
                                                     [model: "anthropic/claude-opus-4-5"] ->
      ...
      result =
        client.work_on_ticket("ERROR-TEST", "Test error handling",
          model: "anthropic/claude-opus-4-5"
        )
  ...
  describe "spawn_subagent for chainlink work" do
    ...
    test "spawn_subagent/2 accepts all valid options" do
      ...
      result =
        client.spawn_subagent("Test task",
          name: "test-task",
          model: "anthropic/claude-sonnet-4-20250514",
          thinking: "medium",
          post_mode: "full"
    ...
    test "spawn_subagent/2 default options work correctly" do
      ...
      result =
        client.spawn_subagent("Minimal task",
          name: "minimal",
          thinking: "low",
          post_mode: "summary"
        )
  ...
  describe "integration flow simulation" do
    test "complete flow: toggle agent -> execute work -> verify correct client called" do
      ...
      try do
        ...
        expect(OpenClawClientMock, :work_on_ticket, fn "FLOW-TEST",
                                                       "Flow test Claude",
                                                       [model: "anthropic/claude-opus-4-5"] ->
        ...
        claude_result =
          openclaw_client.work_on_ticket("FLOW-TEST", "Flow test Claude",
            model: "anthropic/claude-opus-4-5"
          )
      ...
      for {agent_type, model} <- models do
        case agent_type do
          :opencode ->
            ...
            expect(OpenCodeClientMock, :send_task, fn "Model test for " <> ^model,
                                                      [model: ^model] ->
          ...
          :claude ->
            ...
            expect(OpenClawClientMock, :work_on_ticket, fn "MODEL-TEST",
            ...
            result =
              openclaw_client.work_on_ticket("MODEL-TEST", "Model test for #{model}",
                model: model
              )
