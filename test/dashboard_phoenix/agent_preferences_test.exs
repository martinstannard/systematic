defmodule DashboardPhoenix.AgentPreferencesTest do
  ...
  describe "agent_mode handling" do
    ...
    test "set_agent_mode updates the mode to round_robin" do
      state = %{coding_agent: "claude", agent_mode: "single", last_agent: "claude", updated_at: nil}
      
      {:reply, :ok, new_state} = AgentPreferences.handle_call({:set_agent_mode, "round_robin"}, self(), state)
    ...
    test "set_agent_mode updates the mode back to single" do
      state = %{coding_agent: "claude", agent_mode: "round_robin", last_agent: "opencode", updated_at: nil}
      
      {:reply, :ok, new_state} = AgentPreferences.handle_call({:set_agent_mode, "single"}, self(), state)
  ...
  describe "round-robin rotation" do
    test "next_agent in single mode returns the coding_agent" do
      state = %{coding_agent: "claude", agent_mode: "single", last_agent: "opencode", updated_at: nil}
    ...
    test "next_agent in round_robin mode alternates from claude to opencode" do
      state = %{coding_agent: "claude", agent_mode: "round_robin", last_agent: "claude", updated_at: nil}
    ...
    test "next_agent in round_robin mode alternates from opencode to claude" do
      state = %{coding_agent: "opencode", agent_mode: "round_robin", last_agent: "opencode", updated_at: nil}
