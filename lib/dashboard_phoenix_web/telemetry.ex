defmodule DashboardPhoenixWeb.Telemetry do
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("dashboard_phoenix.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("dashboard_phoenix.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("dashboard_phoenix.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("dashboard_phoenix.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("dashboard_phoenix.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
  ...
  defp periodic_measurements do
    [
      ...
      # {DashboardPhoenixWeb, :count_users, []}
    ]
  end
end
